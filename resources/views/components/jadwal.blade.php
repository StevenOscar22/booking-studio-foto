<form action="/submit_booking" method="post" class="mb-10" id="formJadwal">
    @csrf
    <!-- Tanggal, Bulan, Hari -->
    ...
    <div class="flex justify-center items-center bg-orange-basic hover:bg-orange-300 rounded-lg transition-all duration-200"
        id="submitBookingActive">
        <button type="submit" class="font-bold text-black w-[90%] h-10">BOOKING</button>
    </div>
    <div class="flex justify-center items-center bg-zinc-600 rounded-lg transition-all duration-200"
        id="submitBookingDisabled">
        <button type="submit" class="font-bold text-black w-[90%] h-10" disabled>BOOKING</button>
    </div>
    {{-- @else --}}
